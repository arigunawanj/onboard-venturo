...
class SalesDetailHelper extends Venturo {
    private $salesdet;

    public function __construct()
    {
        $this->salesdet = new SalesDetailModel();
    }
    ...
    {
        try {
            $role = $this->salesdet->store($payload);
    ...
    {
        $roles = $this->salesdet->getAll($filter, $itemPerPage, $sort);
